...
# CLAUDE.md — 4N Clinic Management System Frontend Guide
...
> Intended model/tool: Claude Sonnet 4.6 / Claude Code  
...
## 19. Development Workflow for Claude
...
## 22. Master Prompt for Claude Sonnet 4.6

Copy this into Claude Code when starting the frontend work:
...
```text
Read CLAUDE.md. Execute Stage 0 only.
...
```text
Read CLAUDE.md and the files in frontend-docs.
...
```text
Read CLAUDE.md and api-endpoint-inventory.md.
...
```text
Read CLAUDE.md and all frontend-docs.
