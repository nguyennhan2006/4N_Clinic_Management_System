...
export const ROLE_COLORS: Record<Role, string> = {
  ...
  LAB_TECHNICIAN: 'bg-indigo-50 text-indigo-700 border-indigo-200',
  PHARMACIST: 'bg-teal-50 text-teal-700 border-teal-200',
}

export const ALL_ROLES: Role[] = ['ADMIN', 'RECEPTIONIST', 'DOCTOR', 'CASHIER', 'MANAGER', 'NURSE', 'LAB_TECHNICIAN', 'PHARMACIST']
